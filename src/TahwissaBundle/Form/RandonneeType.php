...
class RandonneeType extends AbstractType
{
    ...
    {
        $builder->add('difficulte',ChoiceType::class, array(
            "attr" => ["class" => "form-control"],
            "choices" => ["Facile" => Randonnee::$FACILE , "Moyenne" => Randonnee::$MOYENNE, "Difficle"=>Randonnee::$DIFFICILE],
            "multiple" => false
        ))
            ->add('distanceParcourue',NumberType::class, array(
                "attr" => ["class" => "form-control","placeholder"=>"Distance parcourue"]
            ))
            ->add('type',TextType::class, array(
                "attr" => ["class" => "form-control","placeholder"=>"Type Randonnée"]
            ))
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'TahwissaBundle\Entity\Randonnee'
        ));
    }
